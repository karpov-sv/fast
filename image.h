...
/* Keyword stuff */
image_keyword_str *image_keyword_add(image_str *, const char *, char *, char *);
image_keyword_str *image_keyword_add_type(image_str *, const char *, char *, char *, char );
void image_keyword_add_int(image_str *, const char *, int , char *);
void image_keyword_add_int64(image_str *, const char *, u_int64_t , char *);
void image_keyword_add_double(image_str *, const char *, double , char *);
void image_keyword_add_time(image_str *, const char *, time_str , char *);
image_keyword_str *image_keyword_find(image_str *, const char *);
char *image_keyword_get_string(image_str *, const char *);
int image_keyword_get_int(image_str *, const char *);
u_int64_t image_keyword_get_int64(image_str *, const char *);
double image_keyword_get_double(image_str *, const char *);
double image_keyword_get_sexagesimal(image_str *, const char *);
