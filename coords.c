...
double coords_sky_distance(double ra1, double dec1, double ra2, double dec2)
{
    double x, y, z;
...
double coords_get_xi(coords_str *coords, double x, double y)
{
...
double coords_get_eta(coords_str *coords, double x, double y)
{
    double xx = x - coords->CRPIX1;
    double yy = y - coords->CRPIX2;
